...
* 🟢 Added functions static benchmark - Brooke Kuhlmann
...
* ✅ Fixed gem dependency spacing - Brooke Kuhlmann
* ✅ Fixed numeric start - Brooke Kuhlmann
* 🔁 Refactored closures as function blocks - Brooke Kuhlmann
